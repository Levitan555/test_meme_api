...
class DeleteMeme(Endpoint):
    ...
    def delete_meme(self, create_post_id, return_token):
        self.response = requests.delete(f'{self.url}/meme/{create_post_id}', headers=return_token)
    ...
    def check_that_post_deleted(self, create_post_id, return_token):
        self.response = requests.get(f'{self.url}//meme/{create_post_id}', headers=return_token)
