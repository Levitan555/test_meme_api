...
# дубль
# @pytest.fixture(scope='session')
# def create_post(return_token):
#     post_run = PostMeme()
#     post_del = DeleteMeme()
#     post_data = post_run.post_meme(return_token.auth_post())
#     yield post_data
#     post_del.delete_meme(post_data['id'], return_token.auth_post())
